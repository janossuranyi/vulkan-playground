#include "renderer/technics/DefaultTechnic.h"
...
namespace jsr {
    ...
    VkResult DefaultTechnic::createPipeline(const GraphichPipelineShaderBinary& shaders)
    {
...
*/
		std::array<VkDescriptorSetLayoutBinding,3> data_binding = {
	...
	uint32_t DefaultTechnic::getPushConstantsSize() const
	{
		return 0;
	}

	std::vector<VkClearValue> DefaultTechnic::getClearValues() const
	{
		VkClearValue color = {};
		VkClearValue depth = {};
