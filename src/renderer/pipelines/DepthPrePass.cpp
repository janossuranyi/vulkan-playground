...
VkResult jsr::DepthPrePass::createPipeline(const GraphichPipelineShaderBinary& shaders)
{
	...
	passCreateInfo.pAttachments = &depthAttachmentDescr;
	...
	VkDescriptorSetLayout layouts[] = { m_engine->getGlobalVarsLayout(), m_engine->getGlobalTexturesLayout(), m_passLayout };
...
std::vector<VkClearValue> jsr::DepthPrePass::getClearValues() const
{
	VkClearValue zclear = {};
