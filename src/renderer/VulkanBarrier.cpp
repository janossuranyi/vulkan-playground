...
namespace jsr {
	...
	PipelineBarrier& PipelineBarrier::add(const std::vector<ImageBarrier>& images)
	{
		m_image_barriers.insert(m_image_barriers.end(), images.begin(), images.end());
		return *this;
	}
	PipelineBarrier& PipelineBarrier::add(const std::vector<MemoryBarrier>& memories)
	{
		m_memory_barriers.insert(m_memory_barriers.end(), memories.begin(), memories.end());
		return *this;
	}
	void PipelineBarrier::issuePipelineBarrierCommand(VkCommandBuffer cmd, VkPipelineStageFlags srcStages, VkPipelineStageFlags dstStages) const
	{
