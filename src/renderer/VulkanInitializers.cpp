...
VkWriteDescriptorSet vkinit::write_descriptor_image(VkDescriptorType type, VkDescriptorSet dstSet, VkDescriptorImageInfo* imageInfo, uint32_t binding, uint32_t arrayIndex)
{
...
VkImageViewCreateInfo vkinit::imageview_create_info(VkFormat format, VkImage image, uint32_t mipCount, VkImageAspectFlags aspectFlags)
{
...
namespace vkinit {
	...
	SamplerBuilder& SamplerBuilder::next(const void* pNext)
	{
		m_create_info.pNext = pNext;
		return *this;
	}

	SamplerBuilder& SamplerBuilder::flags(VkSamplerCreateFlags flags_)
	{
		m_create_info.flags = flags_;
		return *this;
	}

	SamplerBuilder& SamplerBuilder::magFilter(VkFilter magFilter_)
	{
		m_create_info.magFilter = magFilter_;
		return *this;
	}

	SamplerBuilder& SamplerBuilder::minFilter(VkFilter minFilter_)
	{
		m_create_info.minFilter = minFilter_;
		return *this;
	}

	SamplerBuilder& SamplerBuilder::filter(VkFilter filter_)
	{
		return minFilter(filter_).magFilter(filter_);
	}

	SamplerBuilder& SamplerBuilder::mipmapMode(VkSamplerMipmapMode mipmapMode_)
	{
		m_create_info.mipmapMode = mipmapMode_;
		return *this;
	}

	SamplerBuilder& SamplerBuilder::addressMode(VkSamplerAddressMode addressMode_)
	{
	...
	SamplerBuilder& SamplerBuilder::addressModeU(VkSamplerAddressMode addressModeU_)
	{
		m_create_info.addressModeU = addressModeU_;
		return *this;
	}

	SamplerBuilder& SamplerBuilder::addressModeV(VkSamplerAddressMode addressModeV_)
	{
		m_create_info.addressModeV = addressModeV_;
		return *this;
	}

	SamplerBuilder& SamplerBuilder::addressModeW(VkSamplerAddressMode addressModeW_)
	{
		m_create_info.addressModeW = addressModeW_;
		return *this;
	}

	SamplerBuilder& SamplerBuilder::mipLodBias(float mipLodBias_)
	{
		m_create_info.mipLodBias = mipLodBias_;
		return *this;
	}

	SamplerBuilder& SamplerBuilder::anisotropyEnable(VkBool32 anisotropyEnable_)
	{
		m_create_info.anisotropyEnable = anisotropyEnable_;
		return *this;
	}

	SamplerBuilder& SamplerBuilder::maxAnisotropy(float maxAnisotropy_)
	{
		m_create_info.maxAnisotropy = maxAnisotropy_;
		return *this;
	}

	SamplerBuilder& SamplerBuilder::compareEnable(VkBool32 compareEnable_)
	{
		m_create_info.compareEnable = compareEnable_;
		return *this;
	}

	SamplerBuilder& SamplerBuilder::compareOp(VkCompareOp compareOp_)
	{
		m_create_info.compareOp = compareOp_;
		return *this;
	}

	SamplerBuilder& SamplerBuilder::minLod(float minLod_)
	{
		m_create_info.minLod = minLod_;
		return *this;
	}

	SamplerBuilder& SamplerBuilder::maxLod(float maxLod_)
	{
		m_create_info.maxLod = maxLod_;
		return *this;
	}

	SamplerBuilder& SamplerBuilder::borderColor(VkBorderColor borderColor_)
	{
		m_create_info.borderColor = borderColor_;
		return *this;
	}

	SamplerBuilder& SamplerBuilder::unnormalizedCoordinates(VkBool32 unnormalizedCoordinates_)
	{
		m_create_info.unnormalizedCoordinates = unnormalizedCoordinates_;
		return *this;
	}

	SamplerBuilder& SamplerBuilder::set_defaults()
	{
		m_create_info = {};
	...
	VkSamplerCreateInfo SamplerBuilder::build()
	{
	...
	VkCommandBufferAllocateInfo command_buffer_allocate_info(VkCommandPool pool, uint32_t count, bool secondary)
	{
